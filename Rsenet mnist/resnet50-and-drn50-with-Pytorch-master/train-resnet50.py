### Train resnet-50 on Fashion MINIST 
import argparse
import shutil
import time
...
parser = argparse.ArgumentParser(description='Training of resnet50 on FashionMNIST')
parser.add_argument("--model", type=str, default='resnet50', help="model:resnet50")
...
def run_training(args):
    ...
    if args.data == 'FashionMNIST':
        ...
        print('Only Training on Fashion MNIST')
...
def train(args, train_loader, model, criterion, optimizer, epoch,  epoch_size):
    ...
    if args.visdom:
        vis_title = 'Resnet50.PyTorch on ' + args.data
